...
extends AbstractPartitionedLimiter.Builder<GrpcServerLimiterBuilder, GrpcServerRequestContext> {
    /**
    ...
    public GrpcServerLimiterBuilder partitionByMethod() {
        ...
        (GrpcServerRequestContext context) -> context.getCall().getMethodDescriptor().getFullMethodName());
    }
